...
class ActorCriticPolicy(BasePolicy):
    ...
    def get_hidden_variables(self) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
        """
        Get Artificial Potential Field (APF) and predicted humans' trajectories within feature extractor in current
        timestep

        :return: tuple of Artificial Potential Field (APF) and predicted humans' trajectories.
        """
