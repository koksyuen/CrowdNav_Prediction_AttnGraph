...
class CrowdSimCL(CrowdSim):
    ...
    def generate_ob(self, reset):
        ...
        :return: observation (numpy array size: obs_len+2 * num_of_visible_humans * 2):
                coordinates of detected human: [:-2, :, :]
                radii (human radius + robot radius): [:-2, :, 1]
                comfort radii (comfort distance + human radius + robot radius): [:-2, :, 0]
